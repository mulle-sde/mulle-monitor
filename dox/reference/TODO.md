# mulle-monitor Documentation Process Guide

## Overview

This document outlines the systematic process for creating comprehensive command documentation for mulle-monitor. Based on practical experience with documentation creation, it provides clear guidelines for what to write, what to avoid, and the step-by-step process to follow.
...
- **MANDATORY: Analyze the main script's main function directly** - Open the main script file (`mulle-monitor/mulle-monitor`) and examine the `monitor::main()` function's case statement to extract ALL available commands
...
- **Identify command categories** (core operations, configuration, system, utility)
...
mulle-monitor <command> <arguments>
mulle-monitor <command> --help
mulle-monitor <command> --verbose

# Good: Workflow examples
mulle-monitor <command1> <args>
mulle-monitor <command2> <args>
mulle-monitor <command3> <args>
```
...
- Core Operations commands (`run`, `callback`, `task`)
- Configuration commands (`patternfile`)
- System information (`list`, `libexec-dir`)

### Medium Priority Commands
- Advanced operations (`clean`)
- Utility commands (`uname`, `version`)
...
### Pre-Documentation
- [ ] **MANDATORY: Read the main script file** (`mulle-monitor/mulle-monitor`) and examine the `monitor::main()` function's case statement
...
#### [Core Operations]
- [ ] `mulle-monitor run <args>` : Monitor files and run scripts
- [ ] `mulle-monitor callback <args>` : Manage callbacks
- [ ] `mulle-monitor task <args>` : Manage tasks

#### [Configuration & Matching]
- [ ] `mulle-monitor patternfile <args>` : Manage patternfiles
- [ ] `mulle-monitor clean <args>` : Clean operations (passed to mulle-match)
- [ ] `mulle-monitor list <args>` : List operations (passed to mulle-match)

#### [System & Utility]
- [ ] `mulle-monitor libexec-dir` : Print path to mulle-monitor libexec
- [ ] `mulle-monitor uname` : Show simplified uname information
- [ ] `mulle-monitor version` : Show version information
- [ ] `mulle-monitor help` : Show help information
...
### Notes
- This is a new documentation session for mulle-monitor
